...
class energy_calc():
    ...
    def __init__(self, datapath: list):
        self.precoolmodel = load(datapath[0])
        self.recovheatmodel = load(datapath[1])
    ...
    def reheatenergy(self, airflow, recovtemp, recov_out_rh,
                     recovtemp_hist, recov_out_rh_hist, sat, sat_hist):
        ...
        return rht_energy, rht_out_rh , rht_energy_hist, rht_out_rh_hist
